<%-- 
    Document   : abone_vt_islemleri
    Created on : 07.Ara.2021, 09:58:57
    Author     : casper
--%>
...
<% 
    ...
    {
        if(bstrp.get(i).getSayfa().equals("abone_veritabani") && bstrp.get(i).getDurum().equals("Aktif"))
        {
            bst_vrm=true;
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div  class="card-header" style="position: relative;" >
                ...
                <h4 class="card-title" style=" font-size: 130%;"> Abone Veritabanı Kontrol Tablosu </h4>
                
                <button type="button" onclick="window.location='?modul=abone_vt_ekle'" class="btn btn-outline-primary  btn-min-width mr-1 mb-1" style=" margin: auto; position: absolute; right:  0.2%; top: 14%; font-size: 110%" ><i class="la la-check"></i> Veritabanı Ekle</button>                                                 
            ...
            <div class="card-content collapse show">
				...
				<tr>
                        ...
                        <%                          
                                            ...
                                            {
                                                if(!ab_vt.get(i).getVt_durum().equals("Sil") && ab_vt.get(i).getVt_tur().equals("abone_vt"))
                                                {
							...
							<tr > <!-- String savePath = "C:/Users/casper/Desktop/sil/Library_project/web/resimler/"; -->
                                                            ...
                                                            <td>
                                                                <div class="text-center" style="padding-top: 5%;  text-align: center; ">  
                                                                    ...
                                                                    <button type="button" onclick="window.location='?modul=abone_vt_guncelle&r_id=<%= m_id%>'" class="btn btn-outline-info round btn-min-width mr-1 mb-1">Düzenle</button>
                                                                    <button type="button" onclick="window.location='?modul=abone_vt_islmlr&m_id=<%=m_id%>&islem=veritbanı_sil'"  class="btn btn-outline-danger round btn-min-width mr-1 mb-1">Kaldır</button>                                                                                                                
                                                                </div>
                                                            </td>      
							</tr>
						</tbody>
