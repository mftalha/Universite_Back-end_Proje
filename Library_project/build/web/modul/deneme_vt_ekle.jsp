<%-- 
    Document   : deneme_vt_ekle
    Created on : 20.Ara.2021, 10:45:24
    Author     : casper
--%>
...
//                                            System.out.println("Başka bir field");
                    ...
                    //sonuc=slider_db.save(sql_slider);
                       ...
                       slider_db.vt_ekle(sql_slider.getVt_isim(),sql_slider.getVt_logo(),sql_slider.getVt_aciklama(),sql_slider.getVt_icerik(),sql_slider.getVt_durum(),birlestir,vt_acls_trh,vt_kpns_trh,sql_slider.getVt_katagori(),"deneme_vt");
                       sonuc=true;
                    } catch (Exception ex) {
                        ex.printStackTrace();
                       sonuc=false; 
...
<div class="alert bg-success alert-dismissible mb-2" role="alert">
									...
									<strong>Deneme Veritabanı Ekleme İşleminiz Başarıyla Gerçekleşmiştir.<br> </strong> 
	    ...
	    <div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="striped-row-layout-basic">Veritabanı İşlemleri & Deneme Veritabanı Ekle</h4>
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
	                	...
	                	<div class="card-text">
							<p><code>Veritabanı İşlemleri & Deneme Veritabanı Ekle:</code> Eklemiş Olduğunuz Veritabanı, Abone Veritabanı İşlemleri Sayfasında Eklenme Tarihine Göre Sıralı Bir Şekilde Tabloda Gösterilir.</p>
						</div>

                            <form  action="?modul=deneme_vt_ekle&islem=ekle" enctype="multipart/form-data" method="POST" class="form form-horizontal striped-rows form-bordered">
	                    	<div class="form-body">
	                    		
								<h4 class="form-section"><i class="la la-database"></i>Veritabanı İşlemleri & Deneme Veritabanı Ekle </h4>
	                        ...
	                        <div class="form-actions">
                                      <button type="button" onclick="window.location='?modul=deneme_vt_islmlr'" class="btn btn-warning btn-lg" style="width: 49%">
