<%-- 
    Document   : menu_alt_acilir_guncelle
    Created on : 01.Kas.2021, 16:18:32
    Author     : casper
--%>
    ...
    if(request.getParameter("islem_son") != null && request.getParameter("islem_son")!= "")
{
    ...
    { //giris_2_son
        ...
        if(request.getParameter("s_2") != null && request.getParameter("s_2")!= "" && request.getParameter("baslik") != null && request.getParameter("baslik")!= "" && request.getParameter("m_id") != null && request.getParameter("m_id")!= "" && request.getParameter("sira_no") != null && request.getParameter("sira_no")!= "" && request.getParameter("km_id") != null && request.getParameter("km_id")!= "")
        {
            String icerik = "null";
            String url = "null";
            ...
            String sm_id = request.getParameter("m_id"); // alt menu id
            int m_id = Integer.parseInt(sm_id); // y_sirano
            
            String kmid = request.getParameter("km_id"); //menu id
            int km_id = Integer.parseInt(kmid); // y_sirano
            ...
            db.alt_acilir_menu_guncelle(baslik, icerik, durum,sira_no, km_id,m_id,knt,url);
            ckt =1;
        ...
        {
            response.sendRedirect("panel.jsp?modul=alt_acilir_menu_guncelle&km_id="+request.getParameter("km_id")+"&bos=bos&m_id="+request.getParameter("m_id"));       
        }    
    }  
}    
if( request.getParameter("km_id") != null && request.getParameter("km_id") != "" && request.getParameter("m_id") != null && request.getParameter("m_id") != "" )
        {
        int m_id = Integer.parseInt(request.getParameter("m_id"));
        ArrayList<acilir_menu> duyurular = db.acilir_menuler_gunc(m_id);
        for(int i=0;i<duyurular.size();i++)
    {
        if(m_id == duyurular.get(i).getAcilir_menu_id())
{
...
<div class="alert bg-success alert-dismissible mb-2" role="alert">
									...
									<strong>Alt Açılır Menü Güncelleme İşleminiz Başarıyla Gerçekleşmiştir.<br> </strong> 
	        ...
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
                            ...
                            <form class="form form-horizontal striped-labels form-bordered" id="form" action="?modul=alt_acilir_menu_guncelle&islem_son=giris_2_son" method="post" name="myform">
	                    	<div class="form-body">
	                    		
					<h4 class="form-section"><i class="ft-clipboard"></i> Alt Açılır Menü Güncelle</h4>
					...
					<div class="form-group row">
                            ...
                            <input type="hidden"   name="m_id" value="<%= duyurular.get(i).getAcilir_menu_id()%>" required>
	                        ...
	                        <div class="form-actions">
                                      <button type="button" onclick="window.location='?modul=acilir_menu_guncelle&km_id=<%=request.getParameter("km_id") %>'" class="btn btn-warning btn-lg" style="width: 49%">
...
<script  type="text/javascript">
        ...
        function ddlselect()
        {
            ...
            { 
                //document.forms['form']['icerik'].value = "New value";
                //document.getElementById("editor").setAttribute('value','My default value');
                //xxyy.value="js de degis_2";
                ur.style.display='none';
                edtr.style.display='';
                //secili = "icerik_ekle";
                document.getElementById("secme_islem").value="icerik";
                //console.log(document.getElementById("projectinput5").value);
                /*
                xxyy = document.getElementById("editor").value;
                console.log("editor_2:"+xxyy);
                let Myelement = document.forms['form']['icerik'].value;
                console.log("editor_3:"+Myelement);
                */
            }
            ...
            {       
                ...
                // var xxyy = document.getElementById("editor").value;
                // var Myelement = document.forms['form']['icerik'].value;
