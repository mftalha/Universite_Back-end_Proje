# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 21:45:57 2021
...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 20:25:40 2021

@author: casper
"""

#2
# gri tonlamada  tekli de , efect yarı-yarıya tamam ,alg_1 aynı ya if(t>2 and j==t) ekledim
...
img_1 = img_boy_7               # donus_max = 254 , his_f = 1.439306358381503
img_2 = img_olc_12  #0.17 sıkıntı         # his_a = 2.190909090909091
...
olcut = 1.1  #histogram oran ,olc 1.1 le, 1.0 arası çıkıyor,1.1 in altına inme
...
if konturol >=4 or (t > 1 and t == konturol):  #efectli resimleri kurtarmak içn histogramda şansları olmuyor
    pp = 1
...
if (donus > ll or konturol == 3)  :
    ...
    #if konturol < 1 :  # resimde 100 noktaya bakıp da konturolü 2 yapamadıysak hala o resime histograma girerken ceza
     #   olcut-=0.   #olcut lerde konturol 0 çıkabiliyor
